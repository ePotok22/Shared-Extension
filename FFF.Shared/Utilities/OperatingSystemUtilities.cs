...
{
    public sealed class OperatingSystemUtilities
    {
        //[SecurityCritical]
        ...
        //        return false;
        //    }
        //    IntPtr functionPointer = NativeMethods.GetProcAddress(hModule, methodName);
...
#pragma warning restore 1591
        ...
        static OperatingSystemUtilities()
        {
        ...
        public static bool IsSupportWindowsStoreApp(out string message)
        {
            ...
            {
                message = @"Your current operating system does not support the windows store app because your windows is lower than windows 8.
** Windows store will support windows 8 and above (8, 8.1, 10).";
            }
            //---------------------------------
            return isSupport;
        }
        ...
        {
            return CurrentProductContains("Windows 11");
        }
